  ...
  return (
    <div className="group bg-white rounded-t-[50%] rounded-b-3xl shadow-[0_4px_20px_rgba(232,213,213,0.3)] border border-pink-powder p-4 relative mt-12 transition-all hover:shadow-[0_8px_30px_rgba(232,213,213,0.5)]">
      ...
      <div className="pt-8 pb-4 text-center bg-white rounded-b-3xl">
        <h3 className="font-display text-xl text-text-main font-bold mb-2 uppercase tracking-wide">
          {title}
        </h3>
        <span className="block font-body text-lg text-accent font-bold mb-4 tracking-widest">
          {price}
        </span>
        <p className="text-xs text-text-main/60 font-light leading-relaxed mb-8 px-4 h-10">
          {description}
        </p>
